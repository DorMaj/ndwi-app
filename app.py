...
ee.Initialize(project='ndwi-mazury-412312')  # <-- wpisz swój projekt

app = Flask(__name__)
CORS(app)

# Maska chmur i cieni dla Landsatów
...
def obrazek():
    ...
    try:
        ...
        # szare tło
        gray = ee.Image.constant([120, 120, 120]).uint8().visualize(min=0, max=255)
        final_image = gray.blend(visualized)
